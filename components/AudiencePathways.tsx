...
const COPY: Record<Language, {
  ...
  en: {
    ...
    cards: [
      { id: 'labs', pageId: 'water-labs', intent: 'quote', title: 'Water testing laboratories', body: 'Kits, controls, reporting and traceability for public and private labs.', pageCta: 'View lab workflow', platformCta: 'Request quote' },
      ...
      { id: 'biotech', pageId: 'biotech-saas', intent: 'saas', title: 'Biotech SaaS teams', body: 'AquaVerify Cloud as an all-in-one LIMS, CRM and operations platform.', pageCta: 'See SaaS platform', platformCta: 'Request demo' }
    ]
  },
  es: {
    ...
    cards: [
      { id: 'labs', pageId: 'water-labs', intent: 'quote', title: 'Laboratorios de análisis de agua', body: 'Kits, controles, reporting y trazabilidad para laboratorios públicos y privados.', pageCta: 'Ver flujo de laboratorio', platformCta: 'Solicitar cotización' },
      ...
      { id: 'biotech', pageId: 'biotech-saas', intent: 'saas', title: 'Equipos biotech SaaS', body: 'AquaVerify Cloud como plataforma todo en uno LIMS, CRM y operaciones.', pageCta: 'Ver plataforma SaaS', platformCta: 'Solicitar demo' }
    ]
  },
  fr: {
    ...
    cards: [
      { id: 'labs', pageId: 'water-labs', intent: 'quote', title: 'Laboratoires d’analyse de l’eau', body: 'Kits, contrôles, rapports et traçabilité pour laboratoires publics et privés.', pageCta: 'Voir le flux laboratoire', platformCta: 'Demander un devis' },
      ...
      { id: 'biotech', pageId: 'biotech-saas', intent: 'saas', title: 'Équipes biotech SaaS', body: 'AquaVerify Cloud comme plateforme LIMS, CRM et opérations tout-en-un.', pageCta: 'Voir la plateforme SaaS', platformCta: 'Demander une démo' }
    ]
  },
  it: {
    ...
    cards: [
      { id: 'labs', pageId: 'water-labs', intent: 'quote', title: 'Laboratori di analisi dell’acqua', body: 'Kit, controlli, report e tracciabilità per laboratori pubblici e privati.', pageCta: 'Vedi workflow lab', platformCta: 'Richiedi preventivo' },
      ...
      { id: 'biotech', pageId: 'biotech-saas', intent: 'saas', title: 'Team biotech SaaS', body: 'AquaVerify Cloud come piattaforma all-in-one LIMS, CRM e operations.', pageCta: 'Vedi piattaforma SaaS', platformCta: 'Richiedi demo' }
    ]
  },
  ca: {
    ...
    cards: [
      { id: 'labs', pageId: 'water-labs', intent: 'quote', title: 'Laboratoris d’anàlisi d’aigua', body: 'Kits, controls, reporting i traçabilitat per a laboratoris públics i privats.', pageCta: 'Veure flux de laboratori', platformCta: 'Sol·licitar pressupost' },
      ...
      { id: 'biotech', pageId: 'biotech-saas', intent: 'saas', title: 'Equips biotech SaaS', body: 'AquaVerify Cloud com a plataforma tot en un LIMS, CRM i operacions.', pageCta: 'Veure plataforma SaaS', platformCta: 'Sol·licitar demo' }
    ]
  }
};
