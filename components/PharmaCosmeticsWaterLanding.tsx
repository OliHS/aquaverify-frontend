...
export const PharmaCosmeticsWaterLanding: React.FC<Props> = ({ content, pageLang, showCookieConsent = true }) => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    trackCorporateEvent('pharma_cosmetics_water_diagnosis_submit', {
      lang: pageLang,
      page: pageId,
      category: 'industries',
      intent: 'pharma_cosmetics_water',
    ...
    <div className="flex min-h-screen flex-col bg-white font-sans text-slate-900">
      ...
      <main className="flex-grow pt-20">
        <section className="relative overflow-hidden bg-slate-950 text-white">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_14%_10%,rgba(20,191,209,0.34),transparent_30%),radial-gradient(circle_at_88%_18%,rgba(14,120,189,0.30),transparent_28%),linear-gradient(135deg,#07334d_0%,#084d6d_46%,#0d7895_100%)]" />
