                            ...
                            <th key={idx} className="p-4 bg-gray-100/50 border-b border-gray-200 text-left w-1/4 align-top">
                              <div className="flex flex-col gap-3">
                                <div className="h-32 bg-white rounded-lg border border-gray-100 p-2 flex items-center justify-center overflow-hidden">
                                  <img 
                                    src={product.image || "https://picsum.photos/200/200?grayscale"} 
                                    alt="" 
                            ...
                            filteredProducts.map((item, idx) => {
                              ...
                              return (
                                <div 
                                  ...
                                  className={`group relative p-4 rounded-lg border transition-all cursor-pointer flex items-start gap-4 ${
                                    isSelected 
                                ...
                                >
                                   ...
                                   <button
                                    ...
                                    className={`p-1 rounded transition-colors z-20 ${
                                      isInCompare ? 'text-secondary hover:text-red-500' : 'text-gray-300 hover:text-secondary opacity-0 group-hover:opacity-100'
                                    }`}
                       ...
                       <div className="bg-surface rounded-2xl p-6 md:p-8 min-h-[500px] border border-gray-100 h-full flex flex-col">
                         {selectedProduct ? (
                           ...
                           >
                              ...
                              >
                                 <img 
                                  src={productImages[0] || "https://picsum.photos/400/300?grayscale"} 
