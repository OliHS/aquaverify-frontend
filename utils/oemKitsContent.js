...
export const OEM_KITS_PAGE = {
  en: withSections({
    ...
    formsTitle: 'Start an OEM or partner conversation',
    formsBody: 'Send country, company type, portfolio, target sectors and estimated volume. AquaVerify will review the most appropriate route.',
    forms: {
      ...
      partner: { title: 'Talk as distributor or commercial partner', body: 'For companies that want to sell AquaVerify products, represent a territory or add a specialized line to their catalog.', submit: 'Send partner request' }
    },
  ...
  es: withSections({
    ...
    formsTitle: 'Inicie una conversacion OEM o de partner',
    formsBody: 'Envie pais, tipo de empresa, cartera, sectores objetivo y volumen estimado. AquaVerify revisara la ruta mas adecuada.',
    forms: {
      ...
      partner: { title: 'Hablar como distribuidor o partner comercial', body: 'Para empresas que quieren vender productos AquaVerify, representar un territorio o anadir una linea especializada a su catalogo.', submit: 'Enviar solicitud de partner' }
    },
  ...
  fr: withSections({
    ...
    formsTitle: 'Demarrer une conversation OEM ou partenaire',
    formsBody: 'Envoyez pays, type d entreprise, portefeuille, secteurs cibles et volume estime. AquaVerify verifiera la route la plus adaptee.',
    forms: { oem: { title: 'Demander programme OEM / marque blanche', body: 'Pour fabricants, marques, laboratoires ou distributeurs qui veulent integrer AquaVerify sous marque propre ou co-branding.', submit: 'Envoyer demande OEM' }, partner: { title: 'Parler comme distributeur ou partenaire commercial', body: 'Pour entreprises qui veulent vendre AquaVerify, representer un territoire ou ajouter une ligne specialisee au catalogue.', submit: 'Envoyer demande partenaire' } },
  ...
  it: withSections({
    ...
    formsTitle: 'Avvia una conversazione OEM o partner',
    formsBody: 'Invia paese, tipo azienda, portfolio, settori target e volume stimato. AquaVerify rivedra il percorso piu adatto.',
    forms: { oem: { title: 'Richiedi programma OEM / private label', body: 'Per produttori, brand, laboratori o distributori che vogliono integrare AquaVerify sotto marchio proprio o co-branding.', submit: 'Invia richiesta OEM' }, partner: { title: 'Parla come distributore o partner commerciale', body: 'Per aziende che vogliono vendere prodotti AquaVerify, rappresentare un territorio o aggiungere una linea specializzata.', submit: 'Invia richiesta partner' } },
  ...
  ca: withSections({
    ...
    formsEyebrow: 'Solicitud',
    formsTitle: 'Inicieu una conversa OEM o de partner',
    formsBody: 'Envieu pais, tipus d empresa, cartera, sectors objectiu i volum estimat. AquaVerify revisara la ruta mes adequada.',
    forms: { oem: { title: 'Sollicitar programa OEM / marca blanca', body: 'Per fabricants, marques, laboratoris o distribuidors que volen integrar AquaVerify sota marca propia o co-branding.', submit: 'Enviar solicitud OEM' }, partner: { title: 'Parlar com a distribuidor o partner comercial', body: 'Per empreses que volen vendre productes AquaVerify, representar un territori o afegir una linia especialitzada al cataleg.', submit: 'Enviar solicitud de partner' } },
