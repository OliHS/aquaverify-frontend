...
const INDUSTRY_PAGE_DATA = [
  {
    ...
    faqs: {
      en: [
        ...
        { question: 'Does it guarantee regulatory compliance?', answer: 'It should not be presented as an automatic compliance guarantee. It helps document processes, results and actions, but compliance depends on the programme, method, laboratory, operator and applicable regulation.' },
      ...
      es: [
        ...
        { question: '¿Garantiza cumplimiento normativo?', answer: 'No debe plantearse como garantía automática de cumplimiento. Ayuda a documentar procesos, resultados y acciones, pero el cumplimiento depende del programa, el método, el laboratorio, el operador y la normativa aplicable.' },
      ...
      fr: [
        ...
        { question: 'Garantit-il la conformité réglementaire ?', answer: 'Il ne doit pas être présenté comme une garantie automatique de conformité. Il aide à documenter processus, résultats et actions, mais la conformité dépend du programme, de la méthode, du laboratoire, de l’opérateur et de la réglementation applicable.' },
      ...
      it: [
        ...
        { question: 'Garantisce la conformità normativa?', answer: 'Non deve essere presentato come garanzia automatica di conformità. Aiuta a documentare processi, risultati e azioni, ma la conformità dipende da programma, metodo, laboratorio, operatore e normativa applicabile.' },
      ...
      ca: [
        ...
        { question: 'Garanteix compliment normatiu?', answer: 'No s’ha de plantejar com una garantia automàtica de compliment. Ajuda a documentar processos, resultats i accions, però el compliment depèn del programa, el mètode, el laboratori, l’operador i la normativa aplicable.' },
